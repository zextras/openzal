...
/* $endif $ */
  ...
  {
    return new FakeLdapFilter(FilterId.SERVER_BY_ALWAYSONCLUSTER);
  }

  public ZLdapFilter serverByServiceAndAlwaysOnCluster(String service, String clusterId)
  {
    return new FakeLdapFilter(FilterId.SERVERY_BY_SERVICE_AND_ALWAYSONCLUSTER);
  }

  public ZLdapFilter alwaysOnClusterById(String cluster)
  {
    return new FakeLdapFilter(FilterId.ALWAYSONCLUSTER_BY_ID);
  }
