...
public class ZEVolume
{
  ...
  public ZEVolume( @NotNull Object vol )
  {
    if ( vol == null )
...
/* $endif$ */
  ...
  public static List<ZEVolume> getAll()
  {
/* $if MajorZimbraVersion <= 7 $
...
/* $endif$ */
    ...
    public static ZEVolume update(short id, short type,
                                  String name, String path,
                                  boolean compressBlobs, long compressionThreshold)
    throws ZimbraException
    {

      ZEVolume volumeToUpdate = ZEVolume.getById(id);
...
/* $endif$ */
      return new ZEVolume(vol);
    }

    public static ZEVolume create(short id, short type,
                                  String name, String path,
                                  boolean compressBlobs, long compressionThreshold)
      throws ZimbraException
    {
...
/* $endif$ */
  ...
  public static ZEVolume setDefaultBits(short id)
    throws ZimbraException
  {
...
/* $endif$ */
    ...
    public static ZEVolume getById(short vid) throws org.openzal.zal.exceptions.ZimbraException
    {
      try
      {
/* $if MajorZimbraVersion <= 7 $
   ...
   $else$ */
        return new ZEVolume(VolumeManager.getInstance().getVolume(vid));
/* $endif$ */
      }
      catch (com.zimbra.common.service.ServiceException e)
      {
    ...
    public static ZEVolume getCurrentSecondaryMessageVolume()
    {
      Volume vol;
/* $if MajorZimbraVersion <= 7 $
...
/* $endif$ */
    ...
    public static List<ZEVolume> getByType(short type)
    {
/*  $if MajorZimbraVersion <= 7 $
...
/*  $endif$ */
    ...
    public static ZEVolume getCurrentMessageVolume()
    {
/* $if MajorZimbraVersion <= 7 $
      return new ZEVolume(Volume.getCurrentMessageVolume());
   $else$ */
      return new ZEVolume(VolumeManager.getInstance().getCurrentMessageVolume());
/* $endif$ */
    }
