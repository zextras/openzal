...
public class ZEMailboxSessionProxy
{
  private final SessionImpl mSession;
  private Integer mMboxId;
  private String     mName;
  private ZEListener mListener;
  private Clock      mClock;

  public ZEMailboxSessionProxy(int mboxId, String name, String accountId, ZEListener listener)
  {
...
/* $endif$ */
    ...
    {
      ZEItem item = new ZEItem((MailItem) what);
      type = item.getType();
    }
    ...
    switch (type)
    {
      case ZEItem.TYPE_MESSAGE:
      case ZEItem.TYPE_CONTACT:
      case ZEItem.TYPE_APPOINTMENT:
      case ZEItem.TYPE_TASK:
        isRelevant = true;
    }
