...
public class ZEDataSource
{
  private final com.zimbra.cs.account.DataSource mDataSource;

  ZEDataSource(@NotNull Object dataSource)
  {
    if ( dataSource == null )
    {
  ...
  public static String decryptData(String dataSourceId, String data)
  {
    try
    {
      return DataSource.decryptData(dataSourceId, data);
    }
  ...
  public static String encryptData(String dataSourceId, String data)
  {
    try
    {
      return DataSource.encryptData(dataSourceId, data);
    }
    catch (ServiceException e)
    {
      throw ExceptionWrapper.wrap(e);
