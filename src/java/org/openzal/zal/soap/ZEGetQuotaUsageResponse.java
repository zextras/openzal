...
import org.openzal.zal.ZEAccountQuotaInfo;
...
public class ZEGetQuotaUsageResponse
{
  /* $if ZimbraVersion >= 8.0.0 $ */
  ...
  protected ZEGetQuotaUsageResponse(Object getQuotaUsageResponse)
  {
  /* $if ZimbraVersion >= 8.0.0 $ */
  ...
  public List<ZEAccountQuotaInfo> getAccountQuotas()
  {
    /* $if ZimbraVersion >= 8.0.0 $ */
