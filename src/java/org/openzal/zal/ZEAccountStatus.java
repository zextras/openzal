...
public class ZEAccountStatus
{
  ...
  public static ZEAccountStatus maintenance = new ZEAccountStatus(ZAttrProvisioning.AccountStatus.maintenance);

  protected ZEAccountStatus(@NotNull Object accountStatus)
  {
