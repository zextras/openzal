...
public class ZEContact extends ZEItem
{
  private final Contact mContact;

  public ZEContact(@NotNull Object item)
  {
    super(item);
  ...
  {
    private final Contact.Attachment mAttachment;

    public ContactAttachment(@NotNull Contact.Attachment attachment)
    {
      if ( attachment == null )
      {
    ...
    {
      mAttachment = new Contact.Attachment(content, ctype, field, filename);
    }
  ...
  public boolean equals(Object o)
  {
    ...
    ZEContact zeContact = (ZEContact) o;
