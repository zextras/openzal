...
public class ZERecurrenceRule
{
  ...
  public ZERecurrenceRule(ZETimeZoneMap tzMap)
  {
    try
    {
  ...
  public ZERecurrenceRule(Object zRecur)
  {
...
*/
  ...
  public void setByDayList(List<ZEWeekDayNum> byDayList)
  {
    List<ZRecur.ZWeekDayNum> dayNumList = new ArrayList<ZRecur.ZWeekDayNum>(byDayList.size());
    for (ZEWeekDayNum zeWeekDayNum : byDayList)
    {
      dayNumList.add(zeWeekDayNum.toZimbra(ZRecur.ZWeekDayNum.class));
    }
