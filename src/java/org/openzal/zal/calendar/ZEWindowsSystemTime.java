...
public class ZEWindowsSystemTime
{
  private final WindowsSystemTime mWindowsSystemTime;

  public ZEWindowsSystemTime(int year, int month, int dayOfWeek, int day, int hour, int minute, int second, int ms)
  {
  ...
  public ZEWindowsSystemTime(@NotNull Object windowsSystemTime)
  {
