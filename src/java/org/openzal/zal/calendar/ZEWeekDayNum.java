...
public class ZEWeekDayNum
{
  ...
  public static class DayComparator implements Comparator<ZEWeekDayNum>
  {
    @Override
    public int compare(ZEWeekDayNum o1, ZEWeekDayNum o2)
    {
